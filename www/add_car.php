        ...
        <form action="" method="post">
            ...
            <div id="info">
                ...
                if (
                    ...
                    echo "<p>Marka musi zawierać od 1 do 30 znaków.</p>";
                    $errors = true;
                }
                ...
                $sql = "INSERT INTO flota(marka,model,kolor,nr_rej,rocznik,przebieg,moc_km,cena) VALUES (?,?,?,?,?,?,?,?)";
